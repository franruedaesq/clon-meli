...
export default function ProductInfo({ data, isFav, selectedAsFavourite }) {
  return (
    <div className="productInfo">
      <div className="productInfo__nuevo">
        {data.condition ? "Nuevo" : "Usado"} | {data.sold_quantity} vendidos{" "}
        <FavouriteHeart
          onFavouriteClic={() => selectedAsFavourite(data.id, isFav)}
          isFavourite={isFav}
        />{" "}
      </div>
      ...
      <div className="productInfo__precio-anterior">
        <p>{data.original_price ? `$ ${data.original_price}` : null}</p>
      </div>
      <div className="productInfo__price">
        <p>${data.price}</p>
      </div>
      <div className="productInfo__envio-normalidad">
        <span>Envio con normalidad</span>
      </div>
      <div className="productInfo__envio-gratis">
        <figure className="productInfo__camion">
          <svg
      ...
      <div className="productInfo__stock-disponible">
